var features = {
    DEBUG : false,
    ACTIVITIES_SHOW_GENERATE_CSV_BUTTON             : false,
    ACTIVITIES_PARIS_THINK18_STYLING                : false,
    BOOKMARK_LINKS_OPEN_IN_NEW_TAB_OR_WINDOW        : false,
    COMMUNITIES_FAVORITE_BUTTON                     : false,
    COMMUNITIES_MEMBERS_BULK_DELETE_BUTTON          : true,
    COMMUNITIES_RECOMMEND_COMMUNITY_TO_SOMEONE      : false,
    NAVBAR_SET_CUSTOM_HOMEPAGE                      : false,
    WIKIS_SIDEBAR_LINKS_SCROLL_TO_TOP_AUTOMATICALLY : false,
    WIKIS_SIDEBAR_LINKS_ENABLE_SCROLLBAR            : false
};
